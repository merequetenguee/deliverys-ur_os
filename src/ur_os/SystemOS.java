...
public final class SystemOS implements Runnable {
    ...
    public void menu() {
        ...
        System.out.println("4. SJF con Estimacion (Next Burst)");
        System.out.println("5. Round Robin");
        System.out.println("6. Por Prioridades");
        System.out.println("7. MFQ");
        System.out.println("8. Fair Scheduler");
        ...
        selectedScheduler = switch (schedulerChoice) {
            ...
            case 4 -> SchedulerType.SJF_E;
            case 5 -> SchedulerType.RR;
            case 6 -> SchedulerType.PRIORITY;
            case 7 -> SchedulerType.MFQ;
            case 8 -> SchedulerType.FAIR;
    ...
    public void run() {
        ...
        try (PrintWriter pw = new PrintWriter(new FileWriter(returnFile()))) {
            ...
            pw.println(this.calcEstimationBias());
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        System.out.println(this.calcEstimationBias());

        System.out.println("*********Comparation:************************");
        compareFiles("C:/Users/Lenovo/Documents/UNIVERSIDAD DEL ROSARIO/V SEMESTRE/Operating System/UR_OS/FCFS.txt",
    ...
    /**
     * Returns a human-readable bias report from the BurstEstimator.
     * Shows N/A when SJF_E was not selected (estimator has no predictions).
     */
    public String calcEstimationBias() {
        BurstEstimator est = BurstEstimator.getInstance();
        if (est.getTotalPredictions() == 0) {
            return "Estimation Bias: N/A (SJF_E not active or no completed burst)";
        }
        return est.getBiasReport();
    }
